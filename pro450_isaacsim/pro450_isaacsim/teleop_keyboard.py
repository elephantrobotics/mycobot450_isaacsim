...
class TeleopKeyboardNode(Node):
    ...
    def __init__(self):
        """Initialize TeleopKeyboardNode and connect to the robot directly."""
    ...
    def send_coords(self):
        ...
        try:
            ...
            # Coordinate control has no direct joint target, so mirror the robot feedback.
            self.sync_isaac_from_robot()
        except Exception:
